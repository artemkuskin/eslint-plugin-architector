...
function resultErrorMessage(
  ...
  if (
    ...
    currentAndTargetLevel.currentModuleLevel.name === currentAndTargetLevel.targetModuleLevel.name &&
    currentAndTargetLevel.lengthTargetPath < currentAndTargetLevel.lengthCurrentPath
  ) {
    errorMessage = ` ${currentAndTargetLevel.currentModuleLevel.name}  ${currentAndTargetLevel.targetModuleLevel.name}`;
  }
  return errorMessage;
}
