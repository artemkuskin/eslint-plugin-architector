...
const displayOfAllErrors = require("./src/rules/displayOfAllErrors");
...
function validateIfImportIsAllowed(pathToCurrentModule, importDefinitionPath, levelsConfiguration, rootDirectory) {
  ...
  if (Boolean(getParentFolder(rootDirectory, pathToCurrentModule))) {
   return displayOfAllErrors (rootDirectory, importDefinitionPath, pathToCurrentModule, levelsConfiguration, jsConfigFileContent)
